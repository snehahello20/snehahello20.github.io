...
<body>
  ...
  ============================-->
    <!--==========================
      Media Section
    ============================-->
    <section id="media" style="padding:10px 0;background:white;">
      <div class="container">
          <div class="row about-extra">
          <div class="col-lg-12 ">
              
         <h5 class="title" style="color:#7e0343;font-weight:700;text-align:center">Click on the Image Link  Below.</h5>
         
<a href="https://technovans.com/startup-story-salary-dost/" target="_blank" >
<img src="img/sir.jpg" style="display: block;
  margin-left: auto;
  margin-right: auto;
  width: 50%;;width:200px;height:200px;border:0;" class="img-fluid" alt="">
